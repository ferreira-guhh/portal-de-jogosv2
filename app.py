...
def get_jogos():
    return jsonify({"mensagem": "API do Portal de Jogos rodando!"})
...
if __name__ == '__main__':
    # O Render injeta uma variável de ambiente chamada PORT. 
    # Se não achar (rodando local), usa a 5000.
    port = int(os.environ.get("PORT", 5000))
    # O host="0.0.0.0" é OBRIGATÓRIO para funcionar em servidores externos
